...
const Blogs = () => {
	return (
		<div> 
		<h1 className="text-center shadow-sm w-50 p-3 mx-auto" style={{backgroundColor:"whitesmoke"}}> Blog Section</h1>
		...
		<div className="container">
			<div className="row">
				<div className="col-md-12 bg-dark rounded p-3 my-2 ">
				 <h3 className="text-white">Difference between javascript and nodejs </h3>
				 <br />
				 	<p className="text-info"> <b className="text-warning">Answer : </b> <small>JavaScript is a simple programming language that runs in any browser JavaScript Engine. Whereas Node JS is an interpreter or running environment for a JavaScript programming language that holds many excesses, it requires libraries that can easily be accessed from JavaScript programming for better use.</small>
				 	</p>
				 </div>

				 <div className="col-md-12 bg-dark rounded p-3 my-2">
				 <h3 className="text-white">When should you use nodejs and when should you use mongodb</h3>
				 <br />
				 <p className="text-info"> <b className="text-warning">Answer : </b> <small>
				 ...
				 <div className="col-md-12 bg-dark rounded p-3 my-2">
				 <h3 className="text-white">What is the purpose of jwt and how does it work </h3>
				 <br />
				 <p className="text-info"> <b className="text-warning">Answer : </b>  
				  <small>
